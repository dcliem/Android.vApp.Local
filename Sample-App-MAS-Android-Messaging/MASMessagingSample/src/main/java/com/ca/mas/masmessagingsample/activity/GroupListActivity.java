        ...
        return new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if (delete) {
                    ...
                    MASFilteredRequest frb = new MASFilteredRequest(attr, IdentityConsts.KEY_GROUP_ATTRIBUTES);
                    frb.isEqualTo(key, groupName);
                    frb.setPagination(IdentityConsts.INDEX_START, IdentityConsts.PAGE_SIZE);
                    frb.setSortOrder(MASFilteredRequestBuilder.SortOrder.descending, key);

                    MASGroup.newInstance().getGroupsByFilter(frb,getGroupCallback());
                } else {
    ...
    private MASCallback<Void> getGroupDeleteCallback() {
        return new MASCallback<Void>() {
            ...
            public void onSuccess(Void result) {
                ...
                getAllGroups(MASUser.getCurrentUser());
            }
